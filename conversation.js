const chat = {
    ...
    27: {
        text:'Peut importe qui nous sommes sur Internet, nos données sont collectées. Nom, Age, adresse, numéro de téléphone, centre d\'intérêts,' +
    ...
    28: {
        text:'La reconnaissance faciale pourrait être prise comme un outil de surveillance de masse pour les états ce qui est étiquement innaceptable. ' +
            'C\'est cette dernière qui pose problème puisqu\'elle ne repond plus aux règles du droit internationnale en matière de surveillance qui dit ' +
            'qu\'elle doit etre strictement ciblée avec des motifs justifiés et légitime. En France, la reconaissance faciale est déjà utilisé, par exemple' +
            ' pour identifier des personnes dans le traitement d\'antécédents judiciaires. La ville est en train de construire un centre de commandement, ' +
    ...
    31: {
        text:'Vous ne le savez peut-être pas mais la société d\'Elon Musk Neuralink vient de commencer à poser de nombreux implants cérébraux sur des ' +
            ...
            ' utilisé à bon escient et qu\'il n\'y ait pas de volonté de manipulation des humains via ces implants ?.',
        next: 39
    },
    ...
    43: {
        text:'Je vous conseille alors d\'aller visiter ce site internet ' +
            ': https://observatoire-ia.ulaval.ca/petit-guide-sur-la-reconnaissance-faciale/',
        next: 25
    },
